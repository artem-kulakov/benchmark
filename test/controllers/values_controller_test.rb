...
class ValuesControllerTest < ActionController::TestCase
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post :create, value: { indicator_id: @value.indicator_id, report_id: @value.report_id, value: @value.value }
    end
  ...
  test "should update value" do
    patch :update, id: @value, value: { indicator_id: @value.indicator_id, report_id: @value.report_id, value: @value.value }
    assert_redirected_to value_path(assigns(:value))
  end
